...
cd "/home/ubuntu/catkin_workspace/src/rosserial/rosserial_python"
...
/usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/ubuntu/catkin_workspace/src/rosserial/rosserial_python/setup.py" \
    build --build-base "/home/ubuntu/catkin_workspace/build/rosserial/rosserial_python" \
    install \
    $DESTDIR_ARG \
